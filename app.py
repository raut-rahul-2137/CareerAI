...
def main():
    st.set_page_config(page_title="Your Career Path Finder", page_icon="🎯", layout="wide")

    st.title("Find Your Perfect Career Match! 🎯")
    st.subheader("Discover which job roles best match your skills and experience")
